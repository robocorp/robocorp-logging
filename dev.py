...
class Dev(object):
    ...
    def build_output_view(self):
        ...
        index_in_dist = os.path.join(src_webview, "dist", "index.html")
        assert os.path.exists(index_in_dist)

        with open(index_in_dist, encoding="utf-8") as stream:
            index_contents = stream.read()
...
INDEX_HTML_CONTENTS = {repr(index_contents)}
"""
            )
